...
La versión 2.0.1 se distribuye directamente desde este repositorio público como marketplace de Codex y Claude Code. El cliente de IA inicia un proceso MCP local por `stdio` cuando lo necesita y lo cierra al terminar.
...
- `plan_linkedin_profile`: prepara briefs trazables para titular, About y experiencia desde el CV confirmado.
- `audit_linkedin_profile_draft`: revisa métricas y términos nuevos antes de que el usuario copie manualmente el perfil.
...
El optimizador de perfil prepara y audita titular, About y experiencias para copia manual. No entra en LinkedIn ni modifica el perfil. Consulta [docs/LINKEDIN-PROFILE.md](docs/LINKEDIN-PROFILE.md).
...
- [Optimizador manual de perfil LinkedIn](docs/LINKEDIN-PROFILE.md)
